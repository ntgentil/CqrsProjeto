...
namespace BaseCore.Validation.Validations
{
    public partial class Contract
    {
        ...
        public Contract HasDateGreaterIqualTo(DateTime data, int anos, string property, string message)
        {
            if (DateTime.Today.AddYears(-anos) <= data)
                AddNotification(property, message);

            return this;
        }

        public Contract HasDateLessIqualTo(DateTime data, int anos, string property, string message)
        {
            if (DateTime.Today.AddYears(-anos) >= data)
                AddNotification(property, message);
